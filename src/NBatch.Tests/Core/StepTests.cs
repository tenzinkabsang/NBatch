...
internal class StepTests
{
    ...
    public void StepIndexNotIncrementedWhenExceptionThrownAndSkipLimitReacher()
    {
        ...
        // When it gets to the second iteration, we return 1 to indicate that we've already had one exception this run
        ...
        // Should throw an exception on the second iteration since the skipLimit is reached.
